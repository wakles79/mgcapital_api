// -----------------------------------------------------------------------
// <copyright file="IProposalServicesRepository.cs" company="Axzes">
...
namespace MGCap.DataAccess.Abstract.Repository
{
    ...
    /// </typeparam>
    public interface IProposalServicesRepository : IBaseRepository<ProposalService, int>
    {
        Task<DataSource<ProposalServiceGridViewModel>> ReadAllDapperAsync(DataSourceRequest request, int proposalId);
    }
}
