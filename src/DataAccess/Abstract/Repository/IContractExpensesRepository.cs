// -----------------------------------------------------------------------
// <copyright file="IContractExpensesRepository.cs" company="Axzes">
...
namespace MGCap.DataAccess.Abstract.Repository
{
    ...
    /// </typeparam>
    public interface IContractExpensesRepository : IBaseRepository<ContractExpense, int>
    {
        Task<DataSource<ContractExpenseGridViewModel>> ReadAllDapperAsync(DataSourceRequest request, int contractId);
    }
}
