...
namespace MGCap.DataAccess.Implementation.Migrations.MGCapDb
{
    ...
    [Migration("20180711212042_ChangeIsExpiredWOEntity")]
    partial class ChangeIsExpiredWOEntity
    {
            ...
            modelBuilder.Entity("MGCap.Domain.Models.WorkOrder", b =>
                {
                    ...
                    b.Property<int>("IsExpired")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasComputedColumnSql("CASE WHEN (CASE WHEN [dbo].[WorkOrders].DueDate = '0001-01-01 00:00:00.0000000' THEN '3000-01-01' ELSE [dbo].[WorkOrders].DueDate END) < GETDATE() THEN 1 ELSE 0 END as IsExpired");
