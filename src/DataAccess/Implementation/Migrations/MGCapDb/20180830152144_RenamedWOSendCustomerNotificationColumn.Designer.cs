...
namespace MGCap.DataAccess.Implementation.Migrations.MGCapDb
{
    ...
    [Migration("20180830152144_RenamedWOSendCustomerNotificationColumn")]
    partial class RenamedWOSendCustomerNotificationColumn
    {
            ...
            modelBuilder.Entity("MGCap.Domain.Models.Building", b =>
                {
                    ...
                    b.Property<int>("IsAvailableForContract")
                        .ValueGeneratedOnAddOrUpdate()
            ...
            modelBuilder.Entity("MGCap.Domain.Models.WorkOrder", b =>
                {
                    ...
                    b.Property<int>("IsExpired")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasComputedColumnSql("CASE WHEN (CASE WHEN [DueDate] = '0001-01-01 00:00:00.0000000' THEN '3000-01-01' ELSE CAST([DueDate] AS DATE) END) < CAST(GETDATE() AS DATE) THEN 1 ELSE 0 END");
                    ...
                    b.Property<string>("RequesterExt")
                        .HasMaxLength(13);
            ...
            modelBuilder.Entity("MGCap.Domain.Models.WorkOrderNotificationTemplate", b =>
                {
                    ...
                    b.Property<string>("HTMLEmailTemplate");

                    b.Property<string>("PlainEmailTemplate");
