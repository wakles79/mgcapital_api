...
namespace MGCap.DataAccess.Implementation.Migrations.MGCapDb
{
    ...
    [Migration("20180716141300_RenamedWORequesterNotificationColumn")]
    partial class RenamedWORequesterNotificationColumn
    {
            ...
            modelBuilder.Entity("MGCap.Domain.Models.WorkOrder", b =>
                {
                    ...
                    b.Property<int>("IsExpired")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasComputedColumnSql("CASE WHEN (CASE WHEN [DueDate] = '0001-01-01 00:00:00.0000000' THEN '3000-01-01' ELSE [DueDate] END) < GETDATE() THEN 1 ELSE 0 END");
