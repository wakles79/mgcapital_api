...
{
    class VendorVendorGroupsRepository : IVendorVendorGroupsRepository
    {
        private bool disposedValue = false; // To detect redundant calls

        /// <summary>
        /// Initializes a new instance of the <see cref="VendorVendorGroupsRepository"/> class.
        /// </summary>
        /// <param name="dbContext">The implementation of <see cref="DbContext"/></param>
        public VendorVendorGroupsRepository(MGCapDbContext dbContext)
        {
            this.DbContext = dbContext;
            this.Entities = (this.DbContext as MGCapDbContext).Set<VendorVendorGroup>();
        }
        ...
        ///     of type TEntity.
        /// </summary>
        public DbSet<VendorVendorGroup> Entities { get; }
        ...
        public VendorVendorGroup Add(VendorVendorGroup obj)
        {
            if (obj == null)
            {
        ...
        /// <param name="obj">The object to be added</param>
        /// <returns>Returns the <paramref name="obj"/> after being inserted</returns>
        public async Task<VendorVendorGroup> AddAsync(VendorVendorGroup obj)
        {
            if (obj == null)
            {
        ...
        public IQueryable<VendorVendorGroup> ReadAll(Func<VendorVendorGroup, bool> filter)
        {
            return this.Entities.Where(ent => filter.Invoke(ent));
        }

        /// <summary>
        ///     Asynchronously filter the elements in the table <see cref="VendorVendorGroup"/> based on
        ///     the given predicate
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        /// <returns>The elements that satisfy the predicate <paramref name="filter"/></returns>
        public async Task<IQueryable<VendorVendorGroup>> ReadAllAsync(Func<VendorVendorGroup, bool> filter)
        {
            return await Task.Factory.StartNew(() =>
            {
                return Entities
                        .Include(ent => ent.VendorGroup)
        ...
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        public void Remove(Func<VendorVendorGroup, bool> filter)
        {
        ...
        public async Task<VendorVendorGroup> UpdateAsync(VendorVendorGroup obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
            ...
            if (!this.Exists(obj.VendorId, obj.VendorGroupId))
            {
        ...
        /// <param name="vendorGroupId">The PK to be checked</param>        /// 
        /// <returns><value>True</value> if the PK exists, false otherwise</returns>
        public bool Exists(int vendorId, int vendorGroupId)
        {
            return this.Entities.Any(ent => ent.VendorId.Equals(vendorId) && ent.VendorGroupId.Equals(vendorGroupId));
        }
        ...
        public async Task<VendorVendorGroup> SingleOrDefaultAsync(Func<VendorVendorGroup, bool> filter)
        {
        ...
        public void Remove(VendorVendorGroup obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
