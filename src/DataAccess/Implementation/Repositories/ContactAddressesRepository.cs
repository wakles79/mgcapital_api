// -----------------------------------------------------------------------
// <copyright file="ContactAddressesRepository.cs" company="Axzes">
...
{
    public class ContactAddressesRepository : IContactAddressesRepository
    {
        private bool disposedValue = false; // To detect redundant calls

        /// <summary>
        /// Initializes a new instance of the <see cref="ContactAddressesRepository"/> class.
        /// </summary>
        /// <param name="dbContext">The implementation of <see cref="DbContext"/></param>
        public ContactAddressesRepository(MGCapDbContext dbContext)
        {
            this.DbContext = dbContext;
            this.Entities = (this.DbContext as MGCapDbContext).Set<ContactAddress>();
        }
        ...
        ///     of type TEntity.
        /// </summary>
        public DbSet<ContactAddress> Entities { get; }
        ...
        public ContactAddress Add(ContactAddress obj)
        {
            if (obj == null)
            {
        ...
        /// <param name="obj">The object to be added</param>
        /// <returns>Returns the <paramref name="obj"/> after being inserted</returns>
        public async Task<ContactAddress> AddAsync(ContactAddress obj)
        {
            if (obj == null)
            {
        ...
        public IQueryable<ContactAddress> ReadAll(Func<ContactAddress, bool> filter)
        {
            return this.Entities.Where(ent => filter.Invoke(ent));
        }

        /// <summary>
        ///     Asynchronously filter the elements in the table <see cref="ContactAddress"/> based on
        ///     the given predicate
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        /// <returns>The elements that satisfy the predicate <paramref name="filter"/></returns>
        public async Task<IQueryable<ContactAddress>> ReadAllAsync(Func<ContactAddress, bool> filter)
        {
            return await Task.Factory.StartNew(() =>
            {
                return Entities
                        .Include(ent => ent.Address)
        ...
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        public void Remove(Func<ContactAddress, bool> filter)
        {
        ...
        public async Task<ContactAddress> UpdateAsync(ContactAddress obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
            ...
            if (!this.Exists(obj.ContactId, obj.AddressId))
            {
        ...
        /// </summary>
        /// <param name="addressId">The PK to be checked</param>
        /// <param name="contactId">The PK to be checked</param>        /// 
        /// <returns><value>True</value> if the PK exists, false otherwise</returns>
        public bool Exists(int contactId, int addressId)
        {
            return this.Entities.Any(ent => ent.AddressId.Equals(addressId) && ent.ContactId.Equals(contactId));
        }
        ...
        public async Task<ContactAddress> SingleOrDefaultAsync(Func<ContactAddress, bool> filter)
        {
        ...
        public void Remove(ContactAddress obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
