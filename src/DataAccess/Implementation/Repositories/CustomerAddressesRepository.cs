// -----------------------------------------------------------------------
// <copyright file="CustomerAddressesRepository.cs" company="Axzes">
...
namespace MGCap.DataAccess.Implementation.Repositories
{
    public class CustomerAddressesRepository : ICustomerAddressesRepository
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerAddressesRepository"/> class.
        /// </summary>
        /// <param name="dbContext">The implementation of <see cref="DbContext"/></param>
        public CustomerAddressesRepository(MGCapDbContext dbContext)
        {
            this.DbContext = dbContext;
            this.Entities = (this.DbContext as MGCapDbContext).Set<CustomerAddress>();
        }
        ...
        ///     of type TEntity.
        /// </summary>
        public DbSet<CustomerAddress> Entities { get; }
        ...
        /// <param name="obj">The object to be added</param>
        /// <returns>Returns the <paramref name="obj"/> after being inserted</returns>
        public async Task<CustomerAddress> AddAsync(CustomerAddress obj)
        {
            if (obj == null)
            {
        ...
        public IQueryable<CustomerAddress> ReadAll(Func<CustomerAddress, bool> filter)
        {
            return this.Entities.Where(ent => filter.Invoke(ent));
        }

        /// <summary>
        ///     Asynchronously filter the elements in the table <see cref="CustomerAddress"/> based on
        ///     the given predicate
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        /// <returns>The elements that satisfy the predicate <paramref name="filter"/></returns>
        public async Task<IQueryable<CustomerAddress>> ReadAllAsync(Func<CustomerAddress, bool> filter)
        {
        ...
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        public void Remove(Func<CustomerAddress, bool> filter)
        {
        ...
        public async Task<CustomerAddress> UpdateAsync(CustomerAddress obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
            ...
            if (!this.Exists(obj.CustomerId, obj.AddressId))
            {
        ...
        public bool Exists(int CustomerId, int addressId)
        {
            return this.Entities.Any(ent => ent.AddressId.Equals(addressId) && ent.CustomerId.Equals(CustomerId));
        }
        ...
        public async Task<CustomerAddress> SingleOrDefaultAsync(Func<CustomerAddress, bool> filter)
        {
        ...
        public void Remove(CustomerAddress obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
