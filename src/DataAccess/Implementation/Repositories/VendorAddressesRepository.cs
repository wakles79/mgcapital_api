...
{
    public class VendorAddressesRepository : IVendorAddressesRepository
    {
        private bool disposedValue = false; // To detect redundant calls

        /// <summary>
        /// Initializes a new instance of the <see cref="VendorAddressesRepository"/> class.
        /// </summary>
        /// <param name="dbContext">The implementation of <see cref="DbContext"/></param>
        public VendorAddressesRepository(MGCapDbContext dbContext)
        {
            this.DbContext = dbContext;
            this.Entities = (this.DbContext as MGCapDbContext).Set<VendorAddress>();
        }
        ...
        ///     of type TEntity.
        /// </summary>
        public DbSet<VendorAddress> Entities { get; }
        ...
        public VendorAddress Add(VendorAddress obj)
        {
            if (obj == null)
            {
        ...
        /// <param name="obj">The object to be added</param>
        /// <returns>Returns the <paramref name="obj"/> after being inserted</returns>
        public async Task<VendorAddress> AddAsync(VendorAddress obj)
        {
            if (obj == null)
            {
        ...
        public IQueryable<VendorAddress> ReadAll(Func<VendorAddress, bool> filter)
        {
            return this.Entities.Where(ent => filter.Invoke(ent));
        }

        /// <summary>
        ///     Asynchronously filter the elements in the table <see cref="VendorAddress"/> based on
        ///     the given predicate
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        /// <returns>The elements that satisfy the predicate <paramref name="filter"/></returns>
        public async Task<IQueryable<VendorAddress>> ReadAllAsync(Func<VendorAddress, bool> filter)
        {
        ...
        /// </summary>
        /// <param name="filter">A function to be applied in each element of the table</param>
        public void Remove(Func<VendorAddress, bool> filter)
        {
        ...
        public async Task<VendorAddress> UpdateAsync(VendorAddress obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
            ...
            if (!this.Exists(obj.VendorId, obj.AddressId))
            {
        ...
        public bool Exists(int vendorId, int addressId)
        {
            return this.Entities.Any(ent => ent.AddressId.Equals(addressId) && ent.VendorId.Equals(vendorId));
        }
        ...
        public async Task<VendorAddress> SingleOrDefaultAsync(Func<VendorAddress, bool> filter)
        {
        ...
        public void Remove(VendorAddress obj)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj), "The given object must not be null");
